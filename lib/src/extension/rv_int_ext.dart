...
extension RvIntExt on Rv<int> {
  /// Bit-wise and operator.
  ///
  /// Treating both `this.value` and [other] as sufficiently large two's component
  /// integers, the result is a number with only the bits set that are set in
  /// both `this.value` and [other]
  ///
  ...
  /// but not both, of `this.value` and [other]
  ///
  ...
  ///
  /// Treating `this.value` as a sufficiently large two's component integer,
  ...
  /// integer dividing both `this.value` and `other`.
  ///
  ...
  ///
  /// If both `this.value` and `other` is zero, the result is also zero.
  ///
  /// Example:
  /// ```dart
  /// print(4.gcd(2)); // 2
  ...
  /// Converts [this.value] to a string representation in the given [radix].
  ///
